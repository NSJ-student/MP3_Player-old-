...
void SPI3_DMA_Init(void)
{
  ...
  HAL_NVIC_EnableIRQ(DMA1_Stream7_IRQn);
    /* SPI3_TX Init */
	VS1003_Tx_DmaHandle.Parent		= &SpiHandle;
    VS1003_Tx_DmaHandle.Instance = DMA1_Stream7;
    VS1003_Tx_DmaHandle.Init.Channel = DMA_CHANNEL_0;
    VS1003_Tx_DmaHandle.Init.Direction = DMA_MEMORY_TO_PERIPH;
    VS1003_Tx_DmaHandle.Init.PeriphInc = DMA_PINC_DISABLE;
    VS1003_Tx_DmaHandle.Init.MemInc = DMA_MINC_ENABLE;
    VS1003_Tx_DmaHandle.Init.PeriphDataAlignment = DMA_PDATAALIGN_BYTE;
    VS1003_Tx_DmaHandle.Init.MemDataAlignment = DMA_MDATAALIGN_WORD;
    VS1003_Tx_DmaHandle.Init.Mode = DMA_NORMAL;
    VS1003_Tx_DmaHandle.Init.Priority = DMA_PRIORITY_HIGH;
    VS1003_Tx_DmaHandle.Init.FIFOMode = DMA_FIFOMODE_ENABLE;
    VS1003_Tx_DmaHandle.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_FULL;
    VS1003_Tx_DmaHandle.Init.MemBurst = DMA_MBURST_SINGLE;
    VS1003_Tx_DmaHandle.Init.PeriphBurst = DMA_PBURST_SINGLE;
    ...
    VS1003_Tx_DmaHandle.Init.MemInc = DMA_MINC_ENABLE;
    VS1003_Tx_DmaHandle.Init.PeriphDataAlignment = DMA_PDATAALIGN_BYTE;
    VS1003_Tx_DmaHandle.Init.MemDataAlignment = DMA_MDATAALIGN_BYTE;
    VS1003_Tx_DmaHandle.Init.Mode = DMA_NORMAL;
    VS1003_Tx_DmaHandle.Init.Priority = DMA_PRIORITY_HIGH;
    VS1003_Tx_DmaHandle.Init.FIFOMode = DMA_FIFOMODE_DISABLE;
    VS1003_Tx_DmaHandle.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_1QUARTERFULL;
    VS1003_Tx_DmaHandle.Init.MemBurst = DMA_MBURST_SINGLE;
    VS1003_Tx_DmaHandle.Init.PeriphBurst = DMA_PBURST_SINGLE;
	*/
    HAL_DMA_Init(&VS1003_Tx_DmaHandle);

    __HAL_LINKDMA(&SpiHandle,hdmatx,VS1003_Tx_DmaHandle);
...
{		 
	...
	*/
	...
	GPIO_InitStructure.Pin 			= XDCS_GPIO_PIN | RESET_GPIO_PIN ;
	...
	/* Configure PB.3(CLK),4(MISO),5(MOSI) pins: SPI3 */
    GPIO_InitStructure.Pin = SCLK_GPIO_PIN | MISO_GPIO_PIN | MOSI_GPIO_PIN;
    GPIO_InitStructure.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStructure.Pull = GPIO_NOPULL;
    GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStructure.Alternate = GPIO_AF6_SPI3;
    HAL_GPIO_Init(VS1033B_GPIO_SPI, &GPIO_InitStructure);
	
	/* Configure PB.6(xCS) */
	GPIO_InitStructure.Pin 			= XCS_GPIO_PIN;
	GPIO_InitStructure.Mode 		= GPIO_MODE_OUTPUT_PP;		// push-pull alternate
	HAL_GPIO_Init(VS1033B_GPIO_SPI, &GPIO_InitStructure);
