...
/* 命令片选 */
#define MP3_CCS(x)	  x ? 	HAL_GPIO_WritePin(VS1033B_GPIO_SPI, XCS_GPIO_PIN, GPIO_PIN_SET) : \
								HAL_GPIO_WritePin(VS1033B_GPIO_SPI, XCS_GPIO_PIN, GPIO_PIN_RESET)
