...
//	FSMC_NORSRAMInit(&FSMC_NORSRAMInitStructure); 
	...
	//FSMC_Bank1->BTCR[FSMC_NORSRAM_BANK1] = 0x00001011;

	/* FSMC写速度设置 */
	FSMC_NORSRAMTimingInitStructure.AddressSetupTime 		= 15;//1;   /* 地址建立时间  */
	FSMC_NORSRAMTimingInitStructure.AddressHoldTime 		= 0;	   
	FSMC_NORSRAMTimingInitStructure.DataSetupTime 			= 15;//1;	   /* 数据建立时间  */
	FSMC_NORSRAMTimingInitStructure.BusTurnAroundDuration = 0x00;
	FSMC_NORSRAMTimingInitStructure.CLKDivision 				= 0x00;
	FSMC_NORSRAMTimingInitStructure.DataLatency 				= 0x00;
	FSMC_NORSRAMTimingInitStructure.AccessMode 			= FSMC_ACCESS_MODE_A;	/* FSMC 访问模式 */
	
	FSMC_NORSRAM_Timing_Init(FSMC_Bank1, &FSMC_NORSRAMTimingInitStructure, FSMC_NORSRAM_BANK1);
	//FSMC_Bank1->BTCR[FSMC_NORSRAM_BANK1 + 1U] = 0x00000F0F;
...
* Attention		 : None
*******************************************************************************/
__forceinline void LCD_WriteReg(uint16_t LCD_Reg,uint16_t LCD_RegValue)
